...
#' @return The function returns an object with items:
#'     \item{eig}{Eigenvalue of the first axis.} \item{ueig}{Rowscores
#'     scaled by eigenvalues.}  \item{v}{Orthonormal column scores.}
#' @author Jari Oksanen.
#' @seealso \code{\link{PCA}} and \code{\link{PCAeig}} for better
#'     algorithms.
#' @references Jongman, R.H., ter Braak, C.J.F & van Tongeren,
#'     O.F.R. (1987) Data analysis in community and landscape
#'     ecology. Wageningen.
